					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{ route('storeBlog') }}" method="post" enctype="multipart/form-data" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										@csrf
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="author" required="required" name="author" value="{{ old('author') }}" class="form-control ">
												@error('author')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
											</div>
										...
										<div class="item form-group">
											<div class="col-md-6 col-sm-6 offset-md-3">
											    <button class="btn btn-primary" type="button" onclick="cancelAction()">Cancel</button>
