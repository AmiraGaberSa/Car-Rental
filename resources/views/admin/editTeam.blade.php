					...
					<div class="row">
						<div class="col-md-12 col-sm-12 ">
							<div class="x_panel">
								...
								<div class="x_content">
									<br />
									<form action="{{route('updateTeam',$team->id)}}" method="post" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
										@csrf
                                        @method('put')
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" name="position" value="{{ $team->position }}" id="position"  class="form-control ">
												@error('position')
                                                {{ $message }}
                                                @enderror
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												...
												<img src="{{asset('assets/admin/images/'. $team->image)}}" alt="" style="width: 300px;">
