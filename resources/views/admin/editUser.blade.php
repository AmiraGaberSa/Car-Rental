									...
									<form method="post" action="{{ route('updateUser',$user->id) }}" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="first-name" name="fullName" value="{{$user->fullName}}" class="form-control ">
												@error('fullName')
                                                {{ $message }}
                                                @enderror
											</div>
										...
										<div class="item form-group">
											...
											<div class="col-md-6 col-sm-6 ">
												<input type="text" id="user-name" name="userName" value="{{$user->userName}}"  class="form-control">
												@error('userName')
                                                {{ $message }}
                                                @enderror
											</div>
