      ...
      <div class="container">
        <div class="row">
          <div class="col-md-8 blog-content">
            <img src="{{asset('assets/admin/images/'.$cars->image)}}" alt="" class="img-fluid p-3 mb-5 bg-white rounded">
          ...
          <div class="col-md-4 sidebar">
            ...
            <div class="sidebar-box">
              <div class="categories">
                ...
                <li><a href="#">{{$category->cat_name}} <span>({{$category->cars->count()}})</span></a></li>
                @endforeach
              </div>
            </div>
            <div class="sidebar-box">
